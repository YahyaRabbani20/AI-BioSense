# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 13:56:48 2024

@author: LABO
"""


##Deconvolution-of-Photoluminescence-PL-Spectra##
...
dataM = np.genfromtxt('Reversibilityafter730M.csv', delimiter=',')
...
# Deconvolution, code from fitting
p = [20, 975, 1,
     20, 1000, 1,
     10, 1050, 1,
     20, 1090, 1,
...
np.savetxt('ReversibilityBeforeFiltrationafter730 dec.csv', PeakSummary, delimiter=',')          # Saving peak as csv
# -------------------------------------------------------#
